export const ExperienceData = [
  ...
  {
    companyName: "Puriya Holdings ",
    location: "Noida, India",
    role: "Game tester , web develoepr ",
    fromTo: "February 2018 - February 2020",
    description:
      "As a game tester my job role was to test and also , I learned about version control tools like Git and GitHub. I spent a lot of time improving my skills in building UI and UX to advance my proficiency in CSS styling and JavaScript logic.",
    side: "left",
  }
];
